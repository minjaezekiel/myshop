...
class Cart:
    ...
    def add(self, product, quantity = 1, override_quantity = False):
        """
        Add product to the cart or update its quatity
        Args:
    ...
    def save(self):
        #marking the session as "modified" to make sure it gets saved 
    ...
    def __iter__(self):
        """
        Iterate over the items in the cart and gets the products from the database
        """
